...
touch "${NGINX_WORKERS_CONFIG_FILE}" 2>/dev/null || { echo >&2 "$ME: error: can not modify ${NGINX_WORKERS_CONFIG_FILE} (read-only file system?)"; exit 0; }
