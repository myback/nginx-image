...
# create nginx user/group first, to be consistent throughout docker variants
    && addgroup -g 10001 -S nginx \
    && adduser -S -D -H -u 10001 -h /var/cache/nginx -s /sbin/nologin -G nginx -g nginx nginx \
...
# create a docker-entrypoint.d directory
    ...
    && rm /etc/nginx/nginx.conf /etc/nginx/conf.d/*.conf

COPY nginx.conf /etc/nginx/nginx.conf
COPY main.d /etc/nginx/main.d
COPY docker-entrypoint.sh /
COPY 20-envsubst-on-templates.sh 30-tune-worker-processes.sh /docker-entrypoint.d
